...
def main():
    parser = argparse.ArgumentParser(description="Evaluate VAMPIRE + FcNet (Cold Start) on all test cases.")
    ...
    config = {
        ...
        'minibatch': 1,
        'minibatch_print': 1,
        'logdir': os.path.join(REPO_ROOT, 'tabular', 'outputs', 'logs_vampire_fcnet'),
    ...
    for tc_path in test_case_files:
        ...
        print("\n" + "="*60)
        print(f"EVALUATION (COLD START): {tc_name} (Task ID {task_id}) [VAMPIRE FCNet]")
