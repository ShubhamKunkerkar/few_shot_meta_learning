...
def main():
    parser = argparse.ArgumentParser(description="Evaluate BMAML + FcNet (Cold Start) on all test cases.")
    ...
    for tc_path in test_case_files:
        ...
        print("\n" + "="*60)
        print(f"EVALUATION (COLD START): {tc_name} (Task ID {task_id}) [BMAML FCNet]")
