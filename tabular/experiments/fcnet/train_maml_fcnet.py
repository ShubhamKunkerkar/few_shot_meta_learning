...
def main():
    ...
    maml.train(train_dataloader=train_dataloader,
               val_dataloader=val_dataloader)

    print("\n--- Training complete. Running evaluation ---")
    maml.test(num_eps=50, eps_dataloader=test_dataloader)

    print("MAML training and evaluation completed successfully!")
